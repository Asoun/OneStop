...
public interface ProductsApi {
    ...
    ResponseEntity<List<Product>> productsGet(@Min(10) @Max(20) @ApiParam(value = "The amount of products returned", allowableValues = "") @Valid @RequestParam(value = "bodyLimit", required = false) Integer bodyLimit,@Min(1) @Max(5) @ApiParam(value = "The pages to return products info", allowableValues = "") @Valid @RequestParam(value = "pageLimit", required = false) Integer pageLimit);
    ...
    ResponseEntity<Product> productsPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Product body) throws NotFoundException;
    ...
    @RequestMapping(value = "/products/{ProductId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Product> productsProductIdGet(@ApiParam(value = "",required=true) @PathVariable("ProductId") Integer productId) throws NotFoundException;
    ...
    @RequestMapping(value = "/products/{ProductName}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Product>> productsProductNameGet(@ApiParam(value = "",required=true) @PathVariable("ProductName") String productName);
